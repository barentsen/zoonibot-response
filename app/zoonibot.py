...
def planethunters_response(ra, dec):
    ...
    result = """Thanks for identifying a possible transit!
                ...
                <a href='http://surveys.roe.ac.uk:8080/wsa/GetImage?ra={0}&dec={0}&database=wserv4v20101019&frameType=stack&obsType=object&programmeID=10209&mode=show&archive=%20wsa&project=wserv4'>a cut-out image of the area near the star</a> to check for nearby neighbours.""".format(ra, dec)
